...
import { Activity, Users, RotateCw, AlertCircle, CheckCircle, MousePointerClick } from 'lucide-react';
                                    ...
                                    {POSITIONS.map((pos) => (
                                        <div key={pos.value} className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-slate-700">
                                                {pos.value === 'WS' ? 'ウイングスパイカー' :
                                                 pos.value === 'MB' ? 'ミドルブロッカー' :
                                                 pos.value === 'S' ? 'セッター' :
                                                 pos.value === 'OP' ? 'オポジット（セッター対角線）' :
                                                 pos.value === 'Li' ? 'リベロ' : ''}
                                            </span>
                                        </div>
                                    ))}
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-slate-50 rounded-lg p-4">
                        ...
                        <div className="space-y-3 text-slate-700 ml-6">
                            ...
                            <ul className="list-disc list-inside text-sm space-y-1">
                                <li><strong>移動先が空き状態のとき</strong>：選手を配置</li>
                                <li><strong>移動先に選手がいるとき</strong>：選手を入れ替え</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                        ...
                        <div className="text-slate-700 ml-6 space-y-2">
                            <p>
                                サイドアウト数の差分でサーブ権が自動判定されます。サーブ権のあるチームの①ポジションが<span className="font-bold text-yellow-600">黄色</span>で光ります。
                            </p>
                            <p className="text-sm bg-white/70 rounded px-3 py-2 border-l-4 border-amber-400">
                                <strong className="text-amber-900">📌 重要:</strong> <strong>チームAが最初のサーブ権チーム</strong>です。試合開始時はチームA側の①ポジションが光ります。
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="space-y-2 text-slate-700 ml-6">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600">チームA/Bの位置を入れ替え＝初期サーブ権の譲渡</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600">現在コートにいる選手をベンチの空き枠に戻す</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-2">
                                <span className="font-mono text-sm bg-red-200 px-2 py-0.5 rounded mt-0.5">🔄</span>
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600">現在選手一覧内にいる選手の並び順を初期状態に戻す</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-blue-200 p-6 space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <div className="bg-white/70 rounded-lg p-4">
                        ...
                        <p className="text-slate-700">
                            <strong>SO（サイドアウト）</strong>: サーブを受けた側が得点<br />
                            <strong>BR（ブレイク）</strong>: サーブを打った側が得点<br />
                    ...
                    <div className="bg-white/70 rounded-lg p-4">
                        ...
                        <ul className="list-disc list-inside text-slate-700 space-y-1">
                            <li>同じチームを両サイドに選択すると警告が表示されます（シミュレーションは可能です）</li>
