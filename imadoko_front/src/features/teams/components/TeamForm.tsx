        ...
        <div className="col-span-2 sm:col-span-4">
          ...
          >
            <div className="relative">
              ...
              >
                <Listbox.Options
                  className={`absolute z-20 max-h-60 w-full overflow-auto rounded-xl bg-white p-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm ${
                    index >= 4 ? 'bottom-full mb-1' : 'mt-1'
                  }`}
                >
                  {POSITIONS.map((pos) => (
                    <Listbox.Option
