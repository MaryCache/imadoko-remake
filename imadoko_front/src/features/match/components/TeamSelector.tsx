...
/**
 * TeamSelector - チーム選択Listbox
 * ドロップダウンでチームを選択するコンポーネント
 */
export const TeamSelector: React.FC<TeamSelectorProps> = ({ value, teams, onChange, placeholder }) => {
    return (
        <Listbox value={value} onChange={onChange}>
            <div className="relative">
                <Listbox.Button className="w-full px-4 py-2.5 rounded-xl border-2 border-sky-200/60 bg-white 
                     focus:border-sky-300 focus:ring-2 focus:ring-sky-200 focus:bg-sky-50/50
                     transition-all duration-200 shadow-sm hover:shadow-md 
                     hover:border-sky-300 hover:bg-sky-50/30 text-slate-900 font-medium text-left">
